...
def test_build_kmodel(cls):
    x_shape = (10,2,3)
    y_shape = (3,)
    fun1 = cls(x_shape, y_shape, build_kmodel=build_kmodel1)
    fun2 = cls(x_shape, y_shape, build_kmodel=build_kmodel2)
    func3 = cls(x_shape, y_shape, build_kmodel=build_kmodel1(x_shape, y_shape))
...
def test_save_and_restore(cls):
    ...
    xs = np.random.random([100]+list(x_shape))
    ys = np.random.random([100]+list(y_shape))
    fun2 = cls(x_shape, y_shape, build_kmodel=build_kmodel1)
    fun2.update(xs)
